...
//#define DJI_HEADING    1      // Adjust for alternative heading calculation =0 GPS, =1 Mag
...
//    uint8_t uk01;		// ??? (possibly compass Z data) NEB Commentato per tilt compens MAG copiato da iNAV
//    uint8_t mask;		// XOR mask
    int16_t magZ;    // compass Y axis data (signed) NEB Aggiunto per tilt compens MAG copiato da iNAV
};
